...
class ConnectDataApp extends State<ConnectDataScreen> {
  ...
  Future<void> ConnectData() async {
    ...
    var url = Uri.parse(
        'https://cors-anyhere.herokuapp.com/https://wavedata.i.tgcloud.io:14240/restpp/query/WaveData/CreateFHIR?useridTXT=${userid}&givenNameTXT=${Uri.encodeComponent(GivenNameTXT.text)}&identifierTXT=${Uri.encodeComponent(IdentifierTXT.text)}&FHIRIDTXT=${int.parse(FHIRIDTXT.text)}');
