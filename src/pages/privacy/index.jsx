    ...
    return (
        <>
          <div className="mb-5" style={{ textAlign: "left", padding: "0 5%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                ...
                <div>
                    <p>
                        At Wave Data, accessible from https://wavedata.com, one of our main
                        priorities is the privacy of our visitors. This Privacy Policy document
                        contains types of information that is collected and recorded by Wave Data
                        and how we use it.
                    </p>
                    <p>
                ...
                <h4>Log Files</h4>
                <p>
                    Wave Data follows a standard procedure of using log files. These files log
                ...
                <div>
                    <p>
                        ...
                        advertising partners of Wave Data.
                    </p>
                    <p>
                        Third-party ad servers or ad networks uses technologies like cookies,
                        JavaScript, or Web Beacons that are used in their respective
                        advertisements and links that appear on Wave Data, which are sent directly
                    ...
                    <p>
                        Note that Wave Data has no access to or control over these cookies that
                        are used by third-party advertisers.
                    </p>
                </div>
                <h4>Third Party Privacy Policies</h4>
                <p>
                    Wave Data's Privacy Policy does not apply to other advertisers or websites.
                ...
                <p>
                    Wave Data does not knowingly collect any Personal Identifiable Information
