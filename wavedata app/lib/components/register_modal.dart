...
class RegisterApp extends State<RegisterModal> {
  ...
  Future<void> RegisterAccount() async {
    ...
    var url = Uri.parse(
        'https://cors-anyhere.herokuapp.com/https://wavedata.i.tgcloud.io:14240/restpp/query/WaveData/checkemail?emailTXT=${Uri.encodeComponent(emailTXT.text)}');
    ...
    if (responseData['results'][1]['(SV.size())'] == 0) {
      var urlReg = Uri.parse(
          'https://cors-anyhere.herokuapp.com/https://wavedata.i.tgcloud.io:14240/restpp/query/WaveData/CreateAccount?FullNameTXT=${Uri.encodeComponent(fullnameTXT.text)}&emailTXT=${Uri.encodeComponent(emailTXT.text)}&passwordTXT=${Uri.encodeComponent(passwordTXT.text)}');
